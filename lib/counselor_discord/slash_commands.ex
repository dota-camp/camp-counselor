defmodule CounselorDiscord.SlashCommands do
  @moduledoc """
  ...
  defp interaction_response(interaction) do
    # A way of handling every interaction that comes into the consumer. It works by
    ...
    #
    # Add .handle_interaction calls here.
    #
