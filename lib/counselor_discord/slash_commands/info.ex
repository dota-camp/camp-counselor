defmodule CounselorDiscord.SlashCommands.Info do
  @moduledoc """
  ...
  def get_command,
    do: %{
      name: "info",
      description: "Information about Camp Counselor"
    }
  ...
  def handle_interaction(_interaction) do
    embed =
      ...
      |> put_title("Camp Counselor information")
      |> put_field("Version", Application.spec(:counselor, :vsn) |> to_string(), true)
      |> put_field("Author", "Tyler Hampton", true)
      |> put_field("Uptime", uptime(), true)
      |> put_field("Source code", "[GitHub](https://github.com/dota-camp/camp-counselor)", true)
